    ...
    /*if (component.data !== '') {
      try {
        ...
        if (this.hasDataFileReference(jsonContents)) {
          console.log(jsonPath + ' has @data reference')
          var myRe = /["']data@(.*)["']/g
          var myArray = myRe.exec(jsonContents)
          // console.log('string to be replaced: ' + myArray[0])
          // console.log('url to be loaded: ' + myArray[1])
          do {
              if (myArray) {
          ...
          // myRe = /["']bla["']/g
          // myArray = myRe.exec('"bla""bla"bla"blabla"')
          // console.log(myArray)
          // // console.log("all References", myArray)
